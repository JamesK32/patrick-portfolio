...
export default function PhotoGallery() {
  return (
    <div className="w-full bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" style={{ height: '500vh' }}>
      {/* Sticky container */}
      <div className="w-full h-screen sticky top-0 flex flex-col items-center justify-center overflow-hidden">
        <div className="text-center mb-8 absolute top-20 z-10">
          ...
          <p className="text-purple-200/70">Scroll to explore the collection</p>
        </div>
